...
pkgname=moksha-theme-radiance
pkgver=0.21.0
_pkgname2=MokshaRadiance
_pkgname3=MokshaRadianceGrey
pkgrel=10
pkgdesc="Moksha Radiance Grey theme"
arch=('any')
...
package() {
  ...
  cp -r ${srcdir}/${_pkgname2}/${_pkgname2}-Icons ${pkgdir}/usr/share/icons/Icons-Moksha-Radiance
  cp -r ${srcdir}/${_pkgname2}/${_pkgname3}-GTK ${pkgdir}/usr/share/themes/Radiance-Graphite
}
