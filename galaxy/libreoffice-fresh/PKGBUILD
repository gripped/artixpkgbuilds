...
makedepends=('curl>=7.20.0' 'hunspell>=1.2.8' 'python' 'libwpd>=0.9.2' 'libwps'
    ...
    'gperf' 'gtk3' 'gtk4' 'cppunit' 'beanshell' 'clucene' 'md4c'
...
source=(${_mirror}/libreoffice{,-help,-translations}-${_LOver}.tar.xz{,.asc}
    ...
    ${_additional_source_url}/pdfium-7681.tar.bz2
    ...
    ${_additional_source_url}/Firebird-3.0.13.33818-0.tar.bz2
    ${_additional_source_url}/skia-m147-ad8ecedbfdef9f4ae4b1e73347b6dd56e6637d38.tar.xz
    ${_additional_source_url}/box2d-3.1.1.tar.gz
...
noextract=(a7983f859eafb2677d7ff386a023bc40-xsltml_2.1.2.zip
           ...
           dtoa-20180411.tgz
           lxml-4.1.1.tgz
           Firebird-3.0.13.33818-0.tar.bz2
           skia-m147-ad8ecedbfdef9f4ae4b1e73347b6dd56e6637d38.tar.xz
           box2d-3.1.1.tar.gz
...
sha256sums=('42116e256933aa575974e420ffa04f7cd7096f4b7ca5d0907ddeaf2a07f68f94'
            'SKIP'
            '8443f21b7127cbd084b472c01ff494ec6a31814f0b1b382004b68103ece90e35'
            'SKIP'
            'dc1419fc6f02840735b01f28b1cd453885e50fad2b2b2f5e6beab93868bf82a4'
            'SKIP'
            ...
            '8de122fff74461770c9ca93ca3e6ca946b077f9110d562f40815e187e1255774'
            ...
            '92f613b60126f9068af02c5eb29abef6931e343888f027d87da100ddf2a003a1'
...
package_libreoffice-fresh-sdk() {
    ...
    depends=('libreoffice-fresh' 'sh' 'make' 'zip'
...
package_libreoffice-fresh() {
    ...
    optdepends=('libreoffice-fresh-i18n: Localizations'
