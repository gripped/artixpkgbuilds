...
source=(${_mirror}/libreoffice{,-help,-translations}-${_LOver}.tar.xz{,.asc}
    ...
    ${_additional_source_url}/zxcvbn-c-2.6.tar.gz
    ${_additional_source_url}/Java-WebSocket-1.6.0.tar.gz
    ${_additional_source_url}/libeot-0.01.tar.bz2
    ...
    fix_build_with_poppler_26.05.0.patch
    fix_build_with_gcc_16.patch
    fix_build_with_poppler_26.06.0.patch)
...
sha256sums=('aff5817dabecab65c16eb641ef2799339df29d75d15544ebd8f8c57605fca02d'
            'SKIP'
            '26aafc8ae7a283b146ec2b9fedb9afc0728dfbcddf233c007562c222f0be15a6'
            'SKIP'
            '92eefdb667a7d0227b37e1254abbee0de64e05d23616682d0b57817d50ecb22d'
            'SKIP'
            ...
            '3f15bba96d017f24532411701ddd5c5957c57935fdf8e3030486f086e15fc2fa'
            'd0be8099cbee3c9dfda694a828149b881c345b204ab68826f317580aafb50879'
            'd7aae12edf82a2a20192ef153ca5132450ae0c6cb9df829b271a2c489c700641'
            ...
            '4c570f4a3c4851920e1ad8a294c632b14937532da12ce0fc4f7f496e64aa093e'
            '2cfb85e09f46ef26fcb00a7a3129d0b1c41847f3968c856037fdc2395375284e'
            'dfbbbc7914ae8a229d2aca08da23147b46858f5ef73b641b3d87231e4a0f9599'
            '656dc3b9a9bbb66b57a2e955e19e57eb97f6a6c4608977144f65db1fc2ae33b5')
...
prepare() {
    ...
    # fix build with orcus 0.21.0
    patch -Np1 -i "${srcdir}"/orcus-0.21.0.patch

    # fix build with poppler 26.01.0 and 26.02.0
    # https://cgit.freedesktop.org/libreoffice/core/patch/?id=b307d254a88a87fe59f9c041346657790c75ac16
    # https://gitweb.gentoo.org/repo/gentoo.git/tree/app-office/libreoffice/files/libreoffice-25.2.7.2-poppler-26.01.patch
    # https://gitweb.gentoo.org/repo/gentoo.git/tree/app-office/libreoffice/files/libreoffice-25.2.7.2-poppler-26.02.patch
    ...
    # fix build with poppler 26.05.0
    # https://www.linuxfromscratch.org/blfs/view/svn/xsoft/libreoffice.html
    patch -Np1 -i "${srcdir}"/fix_build_with_poppler_26.05.0.patch

    # fix build with poppler 26.06.0
    patch -Np1 -i ../fix_build_with_poppler_26.06.0.patch

    # fix build with gcc 16
    # https://gitweb.gentoo.org/repo/gentoo.git/tree/app-office/libreoffice/files/libreoffice-25.2.4.3-gcc16.patch
    patch -Np1 -i "${srcdir}"/fix_build_with_gcc_16.patch
...
package_libreoffice-still() {
    ...
    optdepends=('libreoffice-still-i18n: Localizations'
