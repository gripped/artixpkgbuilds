...
source=(${_mirror}/libreoffice{,-help,-translations}-${_LOver}.tar.xz{,.asc}
    ...
    ${_additional_source_url}/pdfium-6764.tar.bz2
    ...
    ${_additional_source_url}/skia-m130-3c64459d5df2fa9794b277f0959ed8a92552bf4c.tar.xz
    ...
    fix_build_with_poppler_25.09.patch
    fix_build_with_poppler_25.10.patch
    mdds-3.0.0.patch
    orcus-0.21.0.patch
...
sha256sums=('21b38b7f429d305b229fb70f3294dd6ccd803f52dad0463d0923cdf143e9c8bd'
            'SKIP'
            '5a0b7e3f5c7d087491c9c9307c78fdb87f4ceb5c899fd7a98c0008c3a4c325ed'
            'SKIP'
            'b15da015cd7c4b5297ad5afd63008ec25b02c6549e5436dd0fa3b05fa96d2c09'
            'SKIP'
            ...
            'c20599b39a06e1c9aaf75a0cffdbcdbadf0d04f3df1f49fcfd35c2a3b5c81659'
            '95b3ce91cd47793e50b29e977d5c9526d9af48bebca93ae66dddeaf65bca4aef'
...
prepare() {
    ...
    # fix build with icu poppler 25.09
    # see https://gerrit.libreoffice.org/c/core/+/190523
    patch -Np1 -i "${srcdir}"/fix_build_with_poppler_25.09.patch

    # fix build with poppler 25.10
    patch -Np1 -i "${srcdir}"/fix_build_with_poppler_25.10.patch
