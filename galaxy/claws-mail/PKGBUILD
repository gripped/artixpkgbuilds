...
depends=('gtk3' 'gnutls' 'startup-notification' 'enchant' 'gpgme'
         'libetpan' 'compface' 'libsm' 'librsvg'
...
optdepends=('python:            needed for some tools'
            ...
            'libappindicator:   for notification plugin'
...
source=(https://www.claws-mail.org/download.php?file=releases/claws-mail-$pkgver.tar.xz{,.asc}
        bash_completion
        libical-4.patch)
sha256sums=('03e0549d5f0fcd7a59804186524105d05ebb5e534d42a4b86a9a90f729ca255b'
            'SKIP'
            '3f6c248b8658cd7a62186bff572cce2525712a498f363cbbda1ed459021c28cb'
            'f4dcf9d877b4c85801fcfba06fb781b0eadda75c889f22213594eef440fe7bc0')
...
prepare() {
  ...
  sed -i 's/ayatana-appindicator/appindicator/' configure.ac src/plugins/notification/notification_ayatana_indicator.c # Use libappindicator
  autoreconf -fiv
}
