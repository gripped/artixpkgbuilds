...
source=("${pkgname}-${pkgver}.tar.gz"::"https://github.com/dbeaver/dbeaver/archive/${pkgver}.tar.gz"
        ...
        "${pkgname}.hook"
        "${pkgname}.install")
sha256sums=('b78598bcaed2cd7e72a23ee6af31273a6da6520aee20c98c4205c850d885bda5'
            'd81e55de7928368cfbca20d7f6c28533f66eb9ee1fbad34d3ae5ac14eaa680d7'
            '2217b378facda39f8d3edd5e54753207f0c887768cb71d7a9d3cf01dc517f378'
...
build() {
  ...
  mvn --batch-mode -Pproduct-dbeaver-ce,product-dbeaver-eclipse-ce -Djdk.xml.maxGeneralEntitySizeLimit=0 -Djdk.xml.totalEntitySizeLimit=0 -T 1C package
  popd
  ...
  # Add missing dependency org.apache.commons.lang3
  install -m 644 "${srcdir}/commons-lang3-3.19.0.jar" \
    "product/repositories/org.jkiss.dbeaver.ce.repository/target/repository/plugins/org.apache.commons.lang3_3.19.0.jar"
}
...
package() {
  ...
  _install_plugin "dbeaver-plugin-apache-poi" "org.apache.commons.lang3"
