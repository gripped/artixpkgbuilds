...
source=("${pkgname}-${pkgver}.tar.gz"::"https://github.com/dbeaver/dbeaver/archive/${pkgver}.tar.gz"
        ...
        "${pkgname}.hook"
        "${pkgname}.install")
sha256sums=('60270e78ad2e826ac3c5e8a6401e98322b53de4ab3a5d48165d0db0cf3b55b91'
            'a1da3635a6b4c2af25aeecb57bbcf4a3a5aa58034999afb788e0d45541456f0b'
            '6b75d3fd14b5cf57553dabff11d0ab4a9a19be017d149e8e94808bcb6eeb6313'
