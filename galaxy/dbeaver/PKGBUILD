...
source=("${pkgname}-${pkgver}.tar.gz"::"https://github.com/dbeaver/dbeaver/archive/${pkgver}.tar.gz"
        ...
        "${pkgname}.hook"
        "${pkgname}.install")
sha256sums=('5dd363fcc30cb5b18a63967be579b0edfa72458df2643e9d70f810f2297b5497'
            '35e06e591462833d3776d34d17e2b77a84b0e7ab2ff6e3779fbc12c5492166ec'
            'd2c03e4e743d236caae8eeddb03e3e4d7dc198d20555f66cb994a8b937f3149f'
