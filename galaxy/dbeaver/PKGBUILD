...
source=("${pkgname}-${pkgver}.tar.gz"::"https://github.com/dbeaver/dbeaver/archive/${pkgver}.tar.gz"
        ...
        "${pkgname}.hook"
        "${pkgname}.install")
sha256sums=('2683033e4e2b993a3419df43f78df612db0dadf9576a7e843c9ca7ba43236bc5'
            'c567832ff86d9590f5fc30ea3cf22284947ed7176433af85d2c20bf154eda406'
            '6a18f2f28f889f2300f918492523bf9c0e583060ec023a466bd45655546c8598'
