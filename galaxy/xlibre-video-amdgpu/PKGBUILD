...
depends=('X-ABI-VIDEODRV_VERSION=28.0' 'glibc')
makedepends=("xlibre-xserver-devel>=25.0" 'xorgproto')
conflicts=("${_pkgname}")
...
sha256sums=('16feeea266c556cc8cb964aad01a565ebb24e900392245120de504cd0495af46')
