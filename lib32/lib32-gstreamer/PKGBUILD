...
build() {
  ...
  local meson_options=(
    ...
    -D gstreamer:package-origin="https://www.artixlinux.org/"
    ...
    -D gst-plugins-base:package-origin="https://www.artixlinux.org/"
    ...
    -D gst-plugins-good:package-origin="https://www.artixlinux.org/"
