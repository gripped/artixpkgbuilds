...
b2sums=('1f380c2fbd7c267a68757fc0d32272daddc4c376a65afda7df4e7a24a9597558ba8e93678f7163499e38d724063eb4446820ac43983a390ac34b15870c83009b'
        'SKIP'
...
sha256sums=('05328b3891c000e6a110a3e7321d8bfbb21631d132bf86bd3d4a8f45c535ef6b'
            'SKIP'
...
package_lib32-vulkan-asahi() {
  pkgdesc="Open-source Vulkan driver for Apple GPUs - 32-bit"
  depends=(
    lib32-expat
    lib32-gcc-libs
    lib32-glibc
...
package_lib32-vulkan-freedreno() {
  pkgdesc="Open-source Vulkan driver for Adreno GPUs - 32-bit"
  depends=(
    lib32-expat
    lib32-gcc-libs
    lib32-glibc
