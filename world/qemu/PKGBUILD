...
sha512sums=('23d64d05381eaefc8894bb0ece2213d068594b42600931c4b32eb7a5c851e0539977449fb0f9940f58af6489bb15aa2dc8f27472e4fa2d7de8983232136eed00'
            'SKIP'
...
b2sums=('3e42b4fe086edef16e32758d5d46fdf3a48629abb782dbe2b739845315d3b29397152e376d52d418e68c7ccf63c868dacf3d2ab2ce67db96cc743ed9bdc6473b'
        'SKIP'
...
package_qemu-common() {
  ...
  (
    ...
    for _name in qemu-system-{aarch64,alpha,arm,avr,hppa,i386,loongarch64,m68k,microblaze,mips{,64,64el,el},or1k,ppc{,64},riscv{32,64},rx,s390x,sh4{,eb},sparc{,64},tricore,x86_64,xtensa{,eb}}; do
