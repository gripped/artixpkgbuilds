...
sha256sums=('6acc4b8878d2cf556776f48a68fce1e26e649cbecdbe71d0fe7aae7ab8fcdbae'
            'SKIP'
            'SKIP'
            'SKIP'
...
prepare() {
	...
	# Fix build with clang21
	# https://src.fedoraproject.org/rpms/mupdf/c/29e29d055620ca689689f749aac575526e01d8e7?branch=rawhide
