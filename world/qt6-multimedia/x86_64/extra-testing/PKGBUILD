...
makedepends=(cmake ninja qt6-declarative qt6-shadertools gst-plugins-base libpulse ffmpeg qt6-quick3d libxrandr)
groups=(qt6)
...
package_qt6-multimedia-ffmpeg() {
  ...
  depends=(qt6-multimedia ffmpeg libva libxrandr)
  provides=(qt6-multimedia-backend)
  groups=()
