...
source=(
  ...
  drop-django-version-requirement.patch
)
sha512sums=('SKIP'
            ...
            'b26b154c3a6f45a7beb2b0d14a3b5016f6c56ad97690dc6e519d25f9978fa66678e4a4582894c21087ab4cfb9d59b4e8ddbc94a15e349046b7f310d21c31c03e')
b2sums=('SKIP'
        ...
        '3405776ddc59b47250470a4fe34e9abef185016aa12d0e8a8319a3b39c057f657f61accb24205cc31c5ea5c78394e54c4d00a84cd828c3e0b676e4cbf92bd42a')
...
prepare() {
  ...
  # Drop the install_requires django version requirement
  patch -Np1 -d $pkgname -i ../drop-django-version-requirement.patch
}
