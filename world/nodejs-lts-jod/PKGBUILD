...
license=(MIT)
depends=(openssl zlib icu libuv c-ares brotli libnghttp2 zstd) # http-parser v8)
makedepends=(python procps-ng ninja)
...
sha256sums=('3acfae100c7b855a4c76520ee0f95cadcace3f4254f16b7d4887f178fc95d4a0'
