...
source=(
  ...
  telepathy-salut-0.8.1-no-libsoup.patch
)
b2sums=(
  ...
  f2b1f637476655e6d9d61ecaf6971b0d4bf086c0283637007084f8df75a15d084a9185a458c8dcbd62a0306f1989ac653cb3bbc2d18972823e119f8abea9b2a8
)
...
prepare() {
  ...
  # Disable file transfer manager (removes libsoup dependency)
  patch -Np1 -i ../telepathy-salut-0.8.1-no-libsoup.patch
