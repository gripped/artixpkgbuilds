...
source=(
  ...
  $pkgname.sysusers
  $pkgname.tmpfiles
  $pkgname-3.3.8-importlib_resources.patch
)
sha512sums=('SKIP'
            ...
            '6d47a8492f1c53a382dc8c6f14251492413415a1f3415e84adb839b35b66feccec19354630065ede04100490c467d9e9547f8c14a8430555086995332b316c43')
b2sums=('SKIP'
        ...
        '73c7b0ba40b309056aa32f1dc308d3b4066407749e590455f0040d4cb2d5d24a438166e093b2ef4f94479635b03ab62cf0c34609aebdec79a645023b16b89818')
validpgpkeys=('541EA0448453394FF77A0ECC9D9B2BA061D0A67C') # Abhilash Raj <maxking@asynchronous.in>

prepare() {
  # use importlib.resources instead of importlib_resources: https://gitlab.com/mailman/mailman/-/merge_requests/1130
  patch -Np1 -d $pkgname -i ../$pkgname-3.3.8-importlib_resources.patch
  cd $pkgname
