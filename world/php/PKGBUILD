...
sha256sums=('561dc4acd5386e47f25be76f2c8df6ae854756469159248313bcf276e282fbb3'
            'SKIP'
...
package_php() {
	...
	rm -f "${pkgdir}/usr/lib/php/modules/"{enchant,gd,sodium,odbc,pdo_dblib,pdo_odbc,pgsql,pdo_pgsql,pspell,snmp,sqlite3,pdo_sqlite,tidy,xsl}.so
