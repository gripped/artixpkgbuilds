...
makedepends=('xorgproto' 'libxxf86vm' 'libmad' 'libxinerama' 'libmng' 'libxss'
             ...
             'enca' 'libdca' 'a52dec' 'unzip' 'mesa'
             'yasm' 'git' 'mpg123' 'ladspa' 'libcdio' 'zlib'
             'libcdio-paranoia' 'subversion' 'x264'
             ...
             'xvidcore' 'ncurses'
             'fontconfig' 'freetype2' 'libx11' 'libxext' 'libgl'
             'lame' 'ttf-font' 'openal' 'speex'
             'libmpeg2' 'nasm' 'sndio')
...
sha512sums=('SKIP'
            ...
            '7b377190c885bf43e5edb10b6caf682da18418eafb969452c6e558e50db38f5ccce3fb09d7a4c799f07ec4a19508a8290f4b43bf965be73b0d0de6349114dfc7')
...
prepare() {
  ...
  # Fix build with ffmpeg 8, https://lists.mplayerhq.hu/pipermail/mplayer-dev-eng/2025-May/074270.html
  patch -p0 -i ../ffmpeg-8.patch
...
package_mplayer() {
  ...
  depends=('ttf-font' 'enca' 'libxss' 'a52dec'
           'lirc' 'libmng' 'libdca' 'aalib' 'libxinerama' 'smbclient'
           'jack' 'libmad' 'libcaca' 'libxxf86vm' 'faad2'
           ...
           'libxext' 'libgl' 'openal' 'speex' 'libmpeg2' 'sndio')
...
package_mencoder() {
  ...
  depends=('glibc' 'enca' 'a52dec' 'x264' 'libx264.so' 'libmng' 'libdca'
           'smbclient' 'libmad' 'faad2' 'mpg123' 'libcdio'
           'libcdio-paranoia' 'libdvdread' 'libdvdnav' 'ffmpeg'
           'libbs2b' 'ncurses' 'libncursesw.so' 'zlib' 'alsa-lib' 'fontconfig'
           'freetype2' 'fribidi' 'giflib' 'libgif.so' 'libogg' 'libvorbis'
