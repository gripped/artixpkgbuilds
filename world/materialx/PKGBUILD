...
license=('Apache-2.0')
depends=('glibc' 'libstdc++' 'libgcc' 'glfw' 'libglvnd' 'libx11' 'libxt' 'python'
         'python-setuptools' 'opencolorio' 'dos2unix' 'zenity' 'hicolor-icon-theme')
...
build() {
  ...
  cmake -S MaterialX -B build -G Ninja \
