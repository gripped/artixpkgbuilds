...
depends=('glibc' 'libgcc' 'libgfortran' 'libgomp')
makedepends=('git' 'cmake' 'perl' 'gcc-fortran')
source=(git+https://github.com/OpenMathLib/OpenBLAS.git#tag=v$pkgver)
sha512sums=('c89c35a615a51bd3602562215ea6e8cb0f185bfa2ae1ac0051d5760074bc05931c82d979e5e63cac3eb5c5616a0494fd0f15b66f9d9d062508da1d8853ca58c8')
