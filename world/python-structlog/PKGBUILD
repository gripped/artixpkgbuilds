...
pkgver=24.4.0
# XXX: manually update tags before pacman 7.0 is out, where unstable checksums caused by upstream .gitattributes [1] are avoided [2]
# [1] https://github.com/hynek/structlog/blob/main/.gitattributes
