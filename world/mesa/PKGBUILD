...
prepare() {
  cd mesa-$pkgver
  patch -Np1 -i ../clang_resource_dir.patch
...
build() {
  local meson_options=(
    -D c_args=-I/usr/include,-I/usr/lib/clang/15.0.7/include
    -D cpp_args=-I/usr/include,-I/usr/lib/clang/15.0.7/include
  ...
  export CMAKE_INSTALL_LIBDIR="/usr"
