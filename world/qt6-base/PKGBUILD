...
prepare() {
  ...
  git -C $_pkgfn cherry-pick -n 8b54513cdcf62047376a5d27d784ad68a8f235bf # Fix qdbus crashes
  git -C $_pkgfn cherry-pick -n 1466f88633b2c29a6159a0c2eacd0c0d6601aa5e # Fix crashes when loading invalid glyphs
}
