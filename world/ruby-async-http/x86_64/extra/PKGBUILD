...
checkdepends=(ruby-bake ruby-bake-modernize ruby-bake-test ruby-bake-test-external
              ruby-async-container ruby-async-rspec ruby-covered ruby-localhost ruby-rack-test
