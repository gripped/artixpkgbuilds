...
source=("https://download.virtualbox.org/virtualbox/${pkgver}/VirtualBox-${_tarver}.tar.bz2"
        ...
        '021-disable-CET-on-kallsyms_lookup_name.patch')
sha256sums=('0642ed4a12b7204cd30c0abbc2c10c1cc7ad55ce1756a01e86a16d4b6b066592'
            ...
            '6d038c245b216ac4ffbfe08998c75350d833c1bd4bda4ccdb685a157e6ce29c2')
...
package_virtualbox() {
    ...
    depends=('curl' 'libcurl.so'
             ...
             'procps-ng'
             'python'
             'qt6-base' #'libQt6Core.so' 'libQt6DBus.so' 'libQt6Gui.so' 'libQt6PrintSupport.so' 'libQt6Widgets.so' 'libQt6Xml.so'
             'qt6-scxml' #'libQt6StateMachine.so'
             'qt6-tools' #'libQt6Help.so'
             'sdl' #'libSDL2-2.0.so'
             'shared-mime-info'
             'xz' 'liblzma.so'
             'zlib' 'libz.so'
