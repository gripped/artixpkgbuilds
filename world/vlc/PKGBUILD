...
b2sums=('7408f02525e27a9078cae120156ca0821cc898aa8e655e04af2d085fe1d59ef33b549a3bc628ceb208e14cc2dd5c1a1b21ec8f68c7379b065bca89c9fb882c83'
        'fece25c3d56af403962b82e1ac91d1b06791ec2cc282d23c91d2608c8614145596f02e00457047ea688c30bf11f422bcc4748f08ec10a70cd5e79c417bf1eda1'
        '8f5568fe8c378b266c4de91070aa262f632d074801bae61cdc160873b4a22f12805a5469905b92c27af0861c80e81a541d0fdf72c5f10d1436cc25086327faea'
        '59f6ac6b3890667c08a6d4772ffc9d9be70443588e3407ef0f8f89f5b9e2f55d14915c0a136b47c27236a18f1679c8aef12c61cf5ef52345818a31d94a50f7d2'
        'c94a9744d844cfc5cec0c5de616fced2f36fbffdda2689a5fa75ed2450220fe79d69b946caad120631a160549130e1b2286067d0eb1db17083c35fd1d1cea0db')
...
build() {
  ...
  # VLC still relies on an old lua version for its scripts (and compat for external scripts)
...
package_vlc() {
  ...
  (
    cd "$pkgdir"
    printf "Moving files and directories to split packages...\n"
    ...
    _pick $pkgname-plugin-tag usr/lib/vlc/plugins/meta_engine/libtaglib_plugin.so
    ...
    _pick vlc-plugins-base usr/lib/vlc/plugins/demux/libdmxmus_plugin.so
...
package_vlc-plugin-libsecret() {
  pkgdesc+=" - libsecret/gnome-keyring/kwallet plugin"
  depends=(
    glib2
    glibc
    libsecret
