...
source=(
  ...
  # https://gitlab.freedesktop.org/gstreamer/gstreamer/-/merge_requests/12338
  0002-opencv-Support-OpenCV-5.patch

  # https://gitlab.freedesktop.org/gstreamer/gstreamer/-/merge_requests/12148
  0003-faac-support-faac-2.0-faac_-API.patch
)
b2sums=('53156b39ad4704688b8300ccfbf05b5c43f3f3657010e17991599e270986750be340365b54218283c8655f2e9c8de372725742316bdc6d21787dd9699f31191b'
        '465c4de8013c5a1183c775aae36e42d8ffe1af0b162c9fb6ea5ebf8bdcc66ee1792d8cda7dee73bfe7dbd084b702bbbcde0a018f2c04fc7a62b903b487a66285'
        'SKIP'
        '51d3271a14edd3b6edaf98256cdcc51972ba7c275c303ed42047b2ce5ea3930f742bf9a296ac2a9580b1817ce0ef68c51969617f770ef139d53949c141d7ed20'
        '77ac82be44c4607ea09cf649a9794c27276d41ff413f61bd1a64e1ff2f5807ff08933aed501702ff07734c315719b137a8c34b7f310c1794647f8575818e3cee'
        '4e425222d8fd1fc3c49750ad4920433e3b298698e96e714fb9d6f887ac62509f2b187a131fa31da53dcedd2a150ca59d3bd7d7519b7df91a0cff90c65094edbc')
validpgpkeys=(
...
package_gst-plugins-bad-libs() {
  ...
  cd root; local files=(
    ...
    usr/lib/girepository-1.0/{CudaGst,Gst{Analytics,BadAudio,CodecParsers,Codecs,Cuda,Dxva,InsertBin,Mpegts,Mse,Play,Player,Transcoder,Va,Vulkan{,Wayland,XCB},WebRTC}}-1.0.typelib
    usr/share/gir-1.0/{CudaGst,Gst{Analytics,BadAudio,CodecParsers,Codecs,Cuda,Dxva,InsertBin,Mpegts,Mse,Play,Player,Transcoder,Va,Vulkan{,Wayland,XCB},WebRTC}}-1.0.gir
...
package_gst-plugin-svthevcenc() {
  pkgdesc+=" - svthevcenc plugin"
  arch=(x86_64)
  depends=(
    "gst-plugins-bad-libs=$pkgver-$pkgrel"
    "gst-plugins-base-libs=$pkgver-$pkgrel"
