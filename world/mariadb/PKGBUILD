...
sha256sums=('9a2a08a021ab6a318468093e958e9bf95c1938ca780aed50a1edbdcef592230b'
            'SKIP'
            'SKIP'
            'SKIP'
            'SKIP'
...
prepare() {
  ...
  cd libmariadb
  git show '0fb69426d13c14cb6af5ceb0dd9ae9d2777abea8' -- libmariadb/mariadb_stmt.c | git apply
}
