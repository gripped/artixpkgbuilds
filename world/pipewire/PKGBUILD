...
b2sums=('85867001aac9e81a015eb042bc4766cbb6c1755a809d4fdbd838bf5433596648d222f5afb88c9a06786c76901f32a270c6cf5499fa7e2f29890357293fd5d6f7'
        ...
        'ea19c2cd60b7b9773b48b2a044c764fbec260ec356d4a0f66a31737015dad5f1509145bf97094988fc2ea55282e98d52df4448a80e46b9e3c2fef57345b87846')
...
package_pipewire() {
  ...
  optdepends=(
    ...
    'pipewire-netjack2: netJACK2 support'
    'pipewire-pulse: PulseAudio replacement'
    'pipewire-roc: ROC streaming'
    'pipewire-session-manager: Session manager'
    'pipewire-system-services: System daemon (not recommended)'
  ...
  (
    ...
    _pick audio usr/lib/$_spaname/aec/libspa-aec-webrtc.so
    _pick audio usr/lib/$_spaname/{alsa,bluez5,filter-graph}
    ...
    _pick netjack2 usr/lib/$_pwname/libpipewire-module-netjack2*.so
    _pick netjack2 usr/share/man/man7/libpipewire-module-netjack2*.7
    ...
    _pick lib usr/lib/$_pwname
    _pick lib usr/lib/$_spaname
    _pick lib usr/lib/lib$_pwname.so*
    _pick lib usr/lib/pkgconfig/lib{$_pwname,$_spaname}.pc
    _pick lib usr/share/man/man7/libpipewire*

    # directories for overrides
    mkdir -p etc/pipewire/{filter-chain,minimal,pipewire,pipewire-avb}.conf.d
  )
...
package_pipewire-audio() {
  ...
  mkdir -p "$pkgdir/etc/pipewire/pipewire-aes67.conf.d"
...
package_pipewire-system-services() {
  pkgdesc+=" - System services"
  depends=(
    "pipewire-pulse=$epoch:$pkgver-$pkgrel"
    "pipewire=$epoch:$pkgver-$pkgrel"
  )
