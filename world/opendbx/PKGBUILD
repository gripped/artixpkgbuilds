...
source=(
  ...
  https://src.fedoraproject.org/rpms/opendbx/raw/rawhide/f/opendbx-c99.patch
)
sha512sums=('dd6d53d29157057dbf4e273fd82c7694e8bc626d3409d6ab9c25627a0fec96418326550fa8004b5341facdc4cd8aae12516224e8bb84e2562482885780ff0e55'
            ...
            '43601435a5f34d96b8742e55e1ba238a69ba95150cd380bf3f90c6508fbad79800699f1955712ed70dafa72ae82b51e0acdd188bb6497c10fd3d0d87599fb3e9')
b2sums=('0a6c983ac1ebdc3ad9390185938f32e13ba9ff2ced6d41390421e1e3a1e9eb639a85d89da7ce2dd67f05fd2fcaebb2f53146f43678e548511403d8cdc4de88da'
        ...
        '8cc4054bdefa8305f55d52ebaac54b61d4d79ad79455b201562ce5aaa37ce7d898d95169a79c498eeb43bc2e7239c2e7a5d7ceac62fbd581130093dd9f3f12e1')
...
prepare() {
  ...
  patch -p1 -i "$srcdir/opendbx-c99.patch"
...
build() {
  ...
  # this code is *old*
  export CXXFLAGS="$CXXFLAGS -std=c++14 -Wno-error=incompatible-pointer-types -Wno-error=int-conversion"
