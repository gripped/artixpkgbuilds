...
prepare() {
  ...
  cd $pkgname
  # Fix crash when pressing spacebar: https://gitlab.archlinux.org/archlinux/packaging/packages/ardour/-/issues/3 
  git cherry-pick -n 49ff88fd75abba5e2b658ffdedff9ed5a16335ce
