...
source=(
  ...
  $_name-remove-pkg_resources.patch::https://github.com/aio-libs/aiosmtpd/commit/98f578389ae86e5345cc343fa4e5a17b21d9c96d.patch
)
sha512sums=('ce920a3cf16920c4100f97db4630e738e9344e789042a8793d260d78f339e11917a42d9b438a43d2c73f259f0b83e47a98acc3d8ec8f34f0ff455b6a6a2cac09'
            ...
            '555e05462f3353373529f67c9dc3a4deb8a805cdf9b432bfb4519b18c3a4585a082052ee6a3e68b1d4fce579196c7f758a8f47c3d3e348e7bf7ac2028f5a79e3')
b2sums=('f196b633030582033769ac7aee8f95231e5387d9cfb8f5f52c7faeb86b72195e88879a096a19c967155f01d9c59c8f61b44a5f229056f2d1292f085ee98a181e'
        ...
        'b6342ff2f470f0515a467bb3fc60065f0d7d4e1cb7063f3d69bbcd0b5dbc093e1a38ef0e95f378ccc0abaf8aa948166a9899c6a8704afd087fccf7359fe367ee')

prepare() {
  cd $_name-$pkgver
  patch -Np1 -i ../fix-python-3.13.patch
  patch -Np1 -i ../$_name-remove-pkg_resources.patch
}
...
check() {
  local pytest_options=(
    ...
    # Fixes test failure due to usage of deprecated asyncio API
    # iscoroutinefunction.
