...
source=(https://www.kernel.org/pub/linux/utils/${pkgname}/${pkgver}/${pkgname}-${pkgver}.tar.{xz,sign}
        exports
        sysusers.d)
# https://mirrors.edge.kernel.org/pub/linux/utils/nfs-utils/2.8.1/sha256sums.asc
sha256sums=('a0be95b08396908048583fcf6b34a7c1ab49d53e8a12eb28673ccfd2eff0c505'
            'SKIP'
