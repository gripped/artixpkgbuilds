...
b2sums=('272122f3b49da2b2c335a60db97797c5c38c13b82e32cb42313d13307df792af59fa33239c1a5c709ec1f4d96863514f4e75f733aa06a3f98d0c713532ef95f9')
validpgpkeys=(
...
package_linux-firmware-intel() {
  ...
  install -Dm644 \
    ${_licdir}/LICENCE.{IntcSST2,adsp_sst,e100,fw_sst_0f28} \
    ${_licdir}/LICENCE.{ibt,iwlwifi,qat}_firmware \
    ${_licdir}/LICENSE.{hfi1,ipu3}_firmware \
    ${_licdir}/LICENSE.{i915,ice*,intel*,ivsc,ixp4xx,xe} \
    -t "${pkgdir}/usr/share/licenses/${pkgname}"
}
