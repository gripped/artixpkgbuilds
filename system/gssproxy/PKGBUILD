...
source=(https://github.com/gssapi/gssproxy/releases/download/v$pkgver/$pkgname-$pkgver.tar.gz
        ...
        0004-Remove-unneeded-include-in-configure-script.patch
        0005-Don-t-check-for-libref_array-explicitly.patch)
...
sha512sums=('6de484c9c1715e8b845106e1b16e1c29805e4104db296eb44ea15e6b6973fd1df0b043d2cdc2798f04c7a0ce66279e356a285684bc3573ef847532ab2b87aca3'
            ...
            '9f07fd797864149bf2ab92b1186eb9f2faab53f19fab22728dd80b82a7e0ea9ca9d43bd6531c028315eeface68587c12dcacd3f8a8b03d1bf9d84430c3a5c6ea'
            '0e7f4f72857b88aada2fae4d99e351217f2399eab49e8660223b52bf4eefb187e6e296ace680571942fe31eb7186f6e57d0c7066013087eb72cea625cf0a31b6')

prepare() {
  cd "$srcdir/gssproxy-$pkgver"
  patch -Np1 -i ../0001-Fix-various-issues-detected-by-static-analysis.patch
  patch -Np1 -i ../0004-Remove-unneeded-include-in-configure-script.patch
  patch -Np1 -i ../0005-Don-t-check-for-libref_array-explicitly.patch
